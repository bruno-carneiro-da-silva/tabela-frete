    ...
    public function run(): void
    {
        $data = [
            ['tipo_de_carga' => 'Granel sólido', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 4.4705, 4.9495, 5.7813, 5.9928, 6.5437],
                'Carga e descarga (CC)' => ['R$', 448.18, 476.09, 558.82, 591.58, 606.24]
            ]],
            ['tipo_de_carga' => 'Granel líquido', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 4.5090, 4.9880, 5.8198, 6.0313, 6.5821],
                'Carga e descarga (CC)' => ['R$', 448.18, 476.09, 558.82, 591.58, 606.24]
            ]],
            ['tipo_de_carga' => 'Frigorificada ou Aquecida', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 5.2381, 5.8067, 6.7403, 6.9660, 7.6478],
                'Carga e descarga (CC)' => ['R$', 488.90, 516.81, 599.54, 636.19, 652.68]
            ]],
            ...
            ['tipo_de_carga' => 'Perigosa (granel sólido)', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 5.1680, 5.6470, 6.4788, 6.7045, 7.2620],
                'Carga e descarga (CC)' => ['R$', 582.23, 610.14, 692.86, 729.52, 746.01]
            ]],
            ['tipo_de_carga' => 'Perigosa (granel líquido)', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 5.2079, 5.6869, 6.5187, 6.7444, 7.3019],
                'Carga e descarga (CC)' => ['R$', 593.21, 621.12, 703.85, 740.50, 756.99]
            ]],
            ['tipo_de_carga' => 'Perigosa (frigorificada ou aquecida)', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 5.7876, 6.3562, 7.2898, 7.5338, 8.2243],
                'Carga e descarga (CC)' => ['R$', 590.69, 618.60, 701.33, 743.04, 761.91]
            ]],
            ['tipo_de_carga' => 'Perigosa (conteinerizada)', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', 4.8177, 5.2967, 6.1285, 6.3542, 6.9117],
                'Carga e descarga (CC)' => ['R$', 537.75, 565.66, 648.39, 685.04, 701.53]
            ]],
            ...
            ['tipo_de_carga' => 'Carga Granel Pressurizada', 'coeficiente_de_custo' => [
                'Deslocamento (CCD)' => ['R$/km', null, 4.9495, 5.7813, null, 6.5437],
                'Carga e descarga (CC)' => ['R$', null, 476.09, 558.82, null, 606.24]
            ]]
        ];
